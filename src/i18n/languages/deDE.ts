export const deDE = {
  ...
  checkout: {
    title: "Zur Kasse",
    acceptTerms:
      "Mit der Bestätigung der Bestellung akzeptiere ich die Allgemeinen Geschäftsbedingungen",
    billingAddress: "Rechnungsadresse",
    shippingAddress: "Lieferadresse",
    creditCard: "Kreditkarte",
    paypal: "Paypal",
    bankTransfer: "Banküberweisung",
    paymentInfoText: "Wählen Sie eine Zahlungsmethode",
    ...
    additionalInfoPlaceholder:
      "Zusätzliche Informationen zur Bestellung, wie z.B. Hinweise zur Lieferadresse",
    anotherPerson: "Eine andere Person wird die Lieferung empfangen",
    anotherPersonInfo: "In den zusätzlichen Informationen angeben",
    orderNumber: "Best.-Nr.",
    orderDate: "Bestelldatum",
    orderStatus: "Bestellstatus",
    orderItems: "Anzahl Artikel",
